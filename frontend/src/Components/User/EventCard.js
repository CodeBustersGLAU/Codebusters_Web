  ...
  function EventCard({ event, onClick }) {
    return (
      <div
        className="bg-gradient-to-br from-blue-700 via-gray-300 to-gray-600 shadow-2xl rounded-xl h-auto p-6 mb-6 cursor-pointer transition-transform transform hover:scale-105 duration-300 hover:shadow-[0px_10px_25px_rgba(0,0,0,0.2)]"
        onClick={onClick}
      >
