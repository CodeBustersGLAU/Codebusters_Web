...
function PastEvents() {
  ...
  <div className="flex justify-center items-center min-h-screen">
    <div
      className={`grid ${
        club.highlights.length === 1 ? "grid-cols-1" : "grid-cols-1 md:grid-cols-2 lg:grid-cols-2"
      } gap-16 md:gap-20 lg:gap-36 justify-items-center`}
    >
      ...
      {selectedEvent && <PastModalEvents event={selectedEvent} onClose={closeModal} />}
    </div>
  );
}
